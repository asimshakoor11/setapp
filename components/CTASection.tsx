...
export default function CTASection() {
  return (
    <section
      className="pb-5 pt-10 lg:pt-[88px] border-b border-setapp-border"
      style={{
        background:
          "linear-gradient(180deg, var(--color-setapp-white) 0%, var(--color-setapp-white) 50%, var(--color-setapp-darkSecondary) 50%, var(--color-setapp-darkSecondary) 100%)",
      }}
    >
      <div className="mx-auto max-w-[1360px] px-5 lg:px-10">
        <div className="bg-setapp-offWhite rounded-[20px] relative overflow-hidden">
          <div className="max-w-[1260px] mx-auto px-10 lg:px-[75px] lg:min-h-[587px] flex flex-col justify-center relative z-10">
            ...
            <div className="mb-15 lg:mb-15 max-w-[800px]">
              <h2 className="text-setapp-dark  text-[36px] lg:text-[46px] font-semibold leading-[60px] tracking-[1.3px]">
